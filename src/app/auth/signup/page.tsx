      ...
      <Card className="w-full max-w-md border-border shadow-lg">
        <CardHeader className="space-y-1 pb-4 text-center">
          ...
          <p className="text-md text-muted-foreground">
            Join SuperStore to start shopping premium IT products
          </p>
        </CardHeader>
        ...
        <CardContent>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <Input id="password" type={showConfirmPassword ? "text" : "password"} placeholder="confirm your password" value={confirmpassword} onChange={(e) => setConfirmpassword(e.target.value)} required />
            ...
            <div className="flex items-start gap-2">
              ...
              <Button type="submit" className="cursor-pointer" disabled={isLoading}>
                {isLoading ? <span className="flex items-center animate-spin">
                <Loader2 /></span> : "Create Account"}
              </Button>
          </form>
        </CardContent>
